...
const TodoForm = ({mode,mutateTodo,selectedtodo,handleCloseModal,usersData}) => {
...
const [initialValues,setInitialValues] =useState({
  ...
  const postTodo =async(values)=>{
    try{
      const {results} = await todoPost('todo',mode=="edit"?'update':'create',mode=="edit"?selectedtodo:undefined,{
