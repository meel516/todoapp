    ...
    <>
      <div className="transition-transform transform hover:scale-105 relative">
        ...
        >
          <div className="todo-card-header flex justify-between items-center border-b pb-2 mb-2">
            ...
            <div className="gap-1 flex items-center">
              ...
              <Pops
          className={"min-w-[170px] top-3 right-2 border-2 rounded-lg cursor-pointer"}
          wrapper={
            <img
        ...
        >
            ...
            <Pops.Item className={"text-blue-400 border-b-2"} onClick={()=>{
              setSelectedtodo(id)
              handleModal(true)
              setMode("edit")
            }}>Edit todo</Pops.Item>
            <Pops.Item className={"text-red-500"}
            onClick={()=>{
              setSelectedtodo(id)
              handleDeleteModal(true)
              setMode("delete")
            }}
            >delete todo</Pops.Item>
